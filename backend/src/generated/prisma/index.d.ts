...
export namespace Prisma {
  ...
  */
  ...
  type UrlGetPayload<S extends boolean | null | undefined | UrlDefaultArgs> =
    $Result.GetResult<Prisma.$UrlPayload, S>;
  ...
  > {
    ...
    createManyAndReturn<T extends UrlCreateManyAndReturnArgs>(
      args?: SelectSubset<T, UrlCreateManyAndReturnArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$UrlPayload<ExtArgs>,
        T,
    ...
    updateManyAndReturn<T extends UrlUpdateManyAndReturnArgs>(
      args: SelectSubset<T, UrlUpdateManyAndReturnArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$UrlPayload<ExtArgs>,
        T,
    ...
    aggregate<T extends UrlAggregateArgs>(
      args: Subset<T, UrlAggregateArgs>,
    ...
    >(
      args: SubsetIntersection<T, UrlGroupByArgs, OrderByArg> & InputErrors,
    ): {} extends InputErrors
  ...
  export type UrlScalarWhereWithAggregatesInput = {
    AND?:
      UrlScalarWhereWithAggregatesInput | UrlScalarWhereWithAggregatesInput[];
